...
extern "C" {
		...
		*/
		...
		/** @brief Open a HID device using a Vendor ID (VID), Product ID
			...
			@param usage_page The Usage Page of the device to open
				               (Optionally NULL).
...
//        HID_API_EXPORT hid_device * HID_API_CALL hid_open(unsigned short vendor_id, unsigned short product_id, const wchar_t *serial_number);
        HID_API_EXPORT hid_device * HID_API_CALL hid_open(unsigned short vendor_id, unsigned short product_id, unsigned short usage_page);
